...
namespace Tests.Runtime.Graph
{
    public class GraphGeneratorTest
    {
        ...
        {
            var graph = GraphGenerator.Generate(Vector3.one);
        ...
        {
            var graph = GraphGenerator.Generate(new Vector3(10, 10, 10));
        ...
        {
            var graph = GraphGenerator.Generate(new Vector3(2, 1, 1));
